...
@push('after-scripts')
    ...
    <script src="{{ asset('vendor/js/app/schedule/edit_dayoff.js') }}"></script>
    <script>
        ...
        <x-slot name="body">
            ...
            <br>
             <div class="row">
                ...
                <x-forms.post :action="route('admin.schedule.updateDayoff')">
                    <input type="hidden" name="dayoff_id" value="{{ $getCurrentDayoff->dayoff_id }}">
                    ...
                    <div class="form-group required row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" name="reason" id="reason" cols="30" rows="10">{{ old('reason', $getCurrentDayoff->reason) }}</textarea>
                        </div>
                    </div><!--form-group-->
                    <div class="row">
